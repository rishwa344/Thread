            ...
            <Dialog open={true} onClose={handleClose} fullWidth fullScreen={_700? false:true}>
                ...
                <DialogContent>
                    <Stack flexDirection={"column"} gap={1} >
                        <Avatar src={pic ? URL.createObjectURL(pic) : "null"} alt="" sx={{
                            width:96,height:96,alignSelf:"center"
                        }}/>
                        <Button size={"large"} sx={{
                            border:"2px solid gray",
                            borderRadius:"10px", width:96,height:40,alignSelf:"center",my:2,
                        ...
                        <input type={"text"} value={"rishwa_patel"} readOnly className={"text1"} />
                    </Stack>
                    ...
                    <Stack flexDirection={'column'} gap={1}>
                        ...
                        <input type={"text"} value={"rishwa_pate"} readOnly className={"text1"}/>
                    </Stack>
                    ...
                    <Stack flexDirection={'column'} gap={1}>
                        ...
                        <input type={"text"} className={"text1"} placeholder={""} onChange={(e)=>setBio(e.target.value)} />
                    </Stack>
